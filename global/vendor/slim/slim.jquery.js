/*
 * Slim v1.1.0 - Image Cropping Made Easy
    ...
    _createClass(Slim, [{
        ...
        value: function _onDropFile(e) {
            ...
            snabbt(drip.firstChild, {
                ...
                complete: function complete() {
                    ...
                    _this15._load(e.target.files[0]);
                }
            });
        }
        ...
        value: function _load(resource, callback) {
            ...
            getImageAsCanvas(resource, function (image, meta) {
                ...
                if (!image) {
                    ...
                    _this16._removeState('busy');
                    _this16._stopProgressLoop();
                ...
                // load the image
                _this16._loadCanvas(image, function () {

                    var intro = _this16._getIntro();
                    ...
                    var animation = {
                        ...
                        complete: function complete() {
                            ...
                            _this16._showButtons();

                            _this16._stopProgressLoop();
                            _this16._removeState('busy');
                            _this16._addState('preview');

                            if (callback) {
                                callback(null, _this16.data);
                            }
                        }
        ...
        value: function _loadCanvas(image, ready) {
            ...
            this._applyTransforms(image, function (transformedImage) {
                ...
                if (_this17._options.service && _this17._options.push) {

                    // ...and is not transformation of initial image
                    if (!_this17._hasInitialImage) {
                        doUpload = true;
                    }
                }

                _this17._save(function () {}, doUpload);
        ...
        value: function _applyTransforms(image, ready) {
            ...
            transformCanvas(image, this._data.actions, function (transformedImage) {
                ...
                _this18._data.output.width = transformedImage.width;
                _this18._data.output.height = transformedImage.height;
                _this18._data.output.image = transformedImage;

                _this18._onTransformCanvas(_this18._data, function (transformedData) {

                    _this18._data = transformedData;

                    ready(_this18._data.output.image);
                });
            });
        }
    }, {
        ...
        value: function _appendEditor() {
            ...
            ImageEditorEvents.forEach(function (e) {
                _this19._imageEditor.element.addEventListener(e, _this19);
            });
        }
    }, {
        key: '_scaleDropArea',
        ...
        value: function _onConfirm(e) {
            ...
            this._applyTransforms(this._data.input.image, function (transformedImage) {
                ...
                // scale the dropzone
                if (_this20._options.ratio === 'free') {
                    _this20._ratio = intro.naturalHeight / intro.naturalWidth;
                    _this20._scaleDropArea(_this20._ratio);
                }
                ...
                setTimeout(function () {
                    ...
                    // show the preview
                    _this20._showPreview(intro, function () {

                        // if
                        // - service set
                        // - and we are pushing
                        // we will upload
                        var willUpload = _this20._options.service && _this20._options.push;

                        // save the data
                        _this20._save(function (err, res) {

                            // done!
                            _this20._toggleButton('upload', true);

                            _this20._stopProgressLoop();
                            _this20._removeState('busy');

                            _this20._showButtons();
        ...
        value: function _save() {
            ...
            this._options.onSave(data, function (data) {
                ...
                if (_this21._output && !_this21._options.service) {
                    _this21._store(data);
                }

                // is remote service defined up async
                if (_this21._options.service && allowUpload) {
                    _this21._upload(data, function (err, res) {

                        // store response
                        if (!err) {
                            _this21._storeServerResponse(res);
                        }

                        // upload returned
                        _this21._options.onComplete(err, res);
        ...
        value: function _upload(data, callback) {
            ...
            function (loaded, total) {
                ...
                _this22._updateProgress(loaded / total);
            },
            ...
            function (obj) {
                ...
                setTimeout(function () {
                    ...
                    statusNode.innerHTML = _this22._options.statusUploadSuccess;
            ...
            function (status) {
                ...
                if (status === 'file-too-big') {
                    html = _this22._options.statusContentLength;
                } else {
                    html = _this22._options.statusUnknownResponse;
                }
        ...
        value: function _hideButtons(callback) {
            ...
            var animation = {
                ...
                opacity: 0,
                allDone: function allDone() {
                    _this23._btnGroup.style.display = 'none';
                    if (callback) {
                        callback();
                    }
                }
        ...
        value: function _doRemove() {
            ...
            setTimeout(function () {
                ...
                _this25._hideButtons(function () {

                    _this25._toggleButton('upload', true);
                });
                ...
                _this25._options.onRemove(_this25, data);
        ...
        value: function _doUpload(callback) {
            ...
            this._hideButtons(function () {
                ...
                // block upload button
                _this26._toggleButton('upload', false);

                _this26._save(function (err, res) {

                    _this26._removeState('upload');
                    _this26._stopProgress();
        ...
        value: function _doDestroy() {
            ...
            if (this._imageHopper) {
                HopperEvents.forEach(function (e) {
                    _this27._imageHopper.element.removeEventListener(e, _this27);
                });
            ...
            if (this._imageEditor) {
                ImageEditorEvents.forEach(function (e) {
                    _this27._imageEditor.element.removeEventListener(e, _this27);
                });
            ...
            nodeListToArray(this._btnGroup.children).forEach(function (btn) {
                btn.removeEventListener('click', _this27);
            });
            ...
            attributes.forEach(function (attribute) {
                ...
                if (matchesAttributeInList(attribute, _this27._originalElementAttributes)) {
                    return;
                }

                // else remove
                _this27._originalElement.removeAttribute(attribute.name);
            });
            ...
            this._originalElementAttributes.forEach(function (attribute) {
                ...
                // add attribute
                _this27._originalElement.setAttribute(attribute.name, attribute.value);
            });
        ...
        value: function options() {
            ...
            var defaults = {
                ...
                onRemove: function onRemove(slim) {}
...
(function () {
    ...
    ['Init', 'Transform', 'Save', 'Complete', 'Remove'].forEach(function (cb) {
