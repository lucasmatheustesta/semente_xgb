  ...
  <body class="animsition app-clinicas app-contacts page-aside-left" style="opacity:0">
    ...
    <div class="page bg-white" style="max-width: 100%; margin-top:0;margin-bottom:0">
      ...
      <div class="page-main">
        ...
        <div style="overflow: hidden;" class="page-header">
          <h1 style="float: left" class="page-title">Áreas de Interesse</h1>

          <div class="pull-sm-right">
              <form action="{{ route('areasinteresse') }}" name="search" id="busca">
                <div class="input-search input-search-dark">
                  <i class="input-search-icon md-search" aria-hidden="true"></i>
                  <input type="text" class="form-control" name="query" value="{{ isset($_GET['query']) ? $_GET['query'] : '' }}" placeholder="Buscar Área de Interesse">
                </div>
              </form>
            </div>
        </div>
              ...
              <table id="registros" class="table table-striped" data-toggle="table" data-sort-name="id" data-sort-order="asc" data-mobile-responsive="true">
                <thead>
                  <tr>
                    ...
                    @can('edit_areasinteresse', 'delete_areasinteresse' )
                ...
                <tbody>
                  @foreach($registros as $registro)
                    <tr id="registro-{{ $registro->id }}">
                      ...
                      @can('edit_areainteresse', 'delete_areainteresse' )
                        <td>
                          @can('edit_areainteresse')
                            <a style="text-decoration:none" title="Editar {!! $registro->nome !!}" href="{{ route('areasinteresse.editar', $registro->id) }}" class="btn btn-success"><i class="icon fa fa-pencil"></i> Editar</a>
                          @endcan
                          @can('delete_areainteresse')
      ...
      <div class="modal-dialog modal-center text-center modal-sm">
        <div class="modal-content">
          ...
          <div class="modal-body" style="padding-top:0">
            ...
            <p style="margin-bottom:0">Tem certeza que deseja excluir a Área de Interesse <b id="nameData"></b>?</p>
          </div>
    ...
    @can('add_areasinteresse')
      <div class="site-action" data-plugin="actionBtn">
        ...
        <a href="{{ route('areasinteresse.adicionar') }}" class="btn-raised btn btn-success btn-floating">
  ...
  <script type="text/javascript">
    jQuery(document).ready(function ($) {
      ...
      function deleteData (id) {
        $.ajax({
          dataType: 'json',
          url: '{{ URL::asset("areas-interesse/deletar") }}/'+id,
          type: 'GET',
          success: function (json) {
            if (json.success) {
              ...
              $('#deleteData').modal('hide');
              toastr.warning('Ops, houve um erro ao excluir a Área de Atuação.');
            }
          },
          error: function () {
            $('#deleteData').modal('hide');
