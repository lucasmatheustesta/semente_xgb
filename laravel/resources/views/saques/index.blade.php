    ...
    <div class="page bg-white" style="max-width: 100%; margin-top:0;margin-bottom:0">
      ...
      <div class="page-main">
        ...
        <div style="overflow: hidden;" class="page-header">
          <h1 style="float: left" class="page-title">Saques</h1>

          <div class="pull-sm-right">
              <form action="{{ route('saques') }}" name="search" id="busca">
                <div class="input-search input-search-dark">
                  <i class="input-search-icon md-search" aria-hidden="true"></i>
                  <input type="text" class="form-control" name="query" value="{{ isset($_GET['query']) ? $_GET['query'] : '' }}" placeholder="Buscar Saque">
                </div>
              </form>
            </div>
        </div>
      ...
      <div class="modal-dialog modal-center text-center modal-sm">
        <div class="modal-content">
          ...
          <div class="modal-body" style="padding-top:0">
            ...
            <p style="margin-bottom:0">Tem certeza que deseja excluir o Saque <b id="nameData"></b>?</p>
          </div>
  ...
  <script type="text/javascript">
    jQuery(document).ready(function ($) {
      ...
      function deleteData (id) {
        $.ajax({
          dataType: 'json',
          url: '{{ URL::asset("saques/deletar") }}/'+id,
          type: 'GET',
