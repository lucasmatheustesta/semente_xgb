...
role="navigation">
  ...
  <div class="navbar-header">
    ...
    <div class="navbar-brand navbar-brand-center site-gridmenu-toggle" data-toggle="gridmenu">
      <img class="navbar-brand-logo" src="{{ URL::asset('assets/images/tooth.png') }}" title="Maximiza Odonto">
      <span class="navbar-brand-text hidden-xs-down">Maximiza Odonto</span>
    </div>
  </div>
  ...
  <div class="navbar-container container-fluid">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" role="menu">
            <a class="dropdown-item" href="javascript:void(0)" role="menuitem">
              <i class="icon md-account" aria-hidden="true"></i> Perfil
            </a>
            <div class="dropdown-divider"></div>
            <a class="dropdown-item" href="{{ route('site.login.sair') }}" role="menuitem">
    ...
    <div class="navbar-brand navbar-brand-center">
      <a title="Dashboard" href="{{ route('admin.dashboard') }}">
        <img class="navbar-brand-logo" src="{{ URL::asset('assets/images/tooth.png') }} " title="Maximiza Odonto">
        <span class="navbar-brand-text hidden-xs-down" style="color: #FFF;">Maximiza Odonto</span>
      </a>
    </div>
  </div>
</nav>