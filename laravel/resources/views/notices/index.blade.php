  ...
  <body class="animsition app-contacts" style="opacity:0">
    ...
    <div class="page" style="max-width: 100%; margin-top:0;margin-bottom:0">
      ...
      <div class="page-header">
        ...
        <a href="{{ route('notices.adicionar') }}" class="btn btn-success btn-lg"><i class="fa fa-plus" aria-hidden="true"></i> Adicionar Aviso</a>
      </div>
         ...
         <div class="page-content-actions">
           ...
           <div class="row">
             <div class="col-xs-12 col-sm-3">
               <form action="{{ route('notices') }}" name="search" id="busca">
                 <div class="input-search">
                   <button type="submit" class="input-search-btn"><i class="icon md-search" aria-hidden="true"></i></button>
                   <input type="text" class="form-control" name="" placeholder="Buscar Aviso">
                 </div>
               </form>
             </div>
              ...
              <div id="registros" class="panel-body">
                <table id="registros" class="table table-hover" data-toggle="table" data-sort-name="id" data-sort-order="asc" data-mobile-responsive="true">
                  ...
                  <tr>
                    ...
                    <th data-field="subtitulo" data-sortable="false">Subtitulo</th>
                    <th data-field="data" data-sortable="false">Data</th>
                  ...
                  @foreach($registros as $registro)
                    <tr id="registro-{{ $registro->id }}">
                      ...
                      <td>{{ $registro->subtitle }}</td>

                      <td></td>

                      <td>
                        <a title="Editar {!! $registro->name !!}" href="{{ route('notices.editar', $registro->id) }}" class="btn btn-success"><i class="icon fa fa-pencil"></i> Editar</a>
      ...
      <div class="modal-dialog modal-center text-center modal-sm">
        <div class="modal-content">
          ...
          <div class="modal-body" style="padding-top:0">
            ...
            <p style="margin-bottom:0">Tem certeza que deseja excluir o aviso <b id="nameData"></b>?</p>
          </div>
  ...
  <script type="text/javascript">
    jQuery(document).ready(function ($) {
      ...
      function deleteData (id) {
        $.ajax({
          dataType: 'json',
          url: '{{ URL::asset("notices/deletar") }}/'+id,
          type: 'GET',
          success: function (json) {
            if (json.success) {
              ...
              $('#deleteData').modal('hide');
              toastr.warning('Ops, houve um erro ao excluir o aviso.');
            }
          },
          error: function () {
            $('#deleteData').modal('hide');
