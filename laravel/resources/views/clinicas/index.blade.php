  ...
  <body class="animsition app-clinicas app-contacts page-aside-left" style="opacity:0">
        ...
        <div class="page-aside-inner page-aside-scroll">
          <div data-role="container">
              <div data-role="content">
                <form id="busca-aside" action="{{ route('clinicas') }}">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                   ...
                   @if((isset($_GET['estado']) and !empty($_GET['estado'])) or (isset($_GET['cidade']) and !empty($_GET['cidade'])) )
                    <a style="margin-left:10px;" href="{{ route('clinicas') }}" title="Limpar" class="btn btn-default">Limpar</a>
                   @endif
                 </div>
            </form>
            <div class="pull-sm-right">
              <form action="{{ route('clinicas') }}" name="search" id="busca">
                <div class="input-search input-search-dark">
                  <i class="input-search-icon md-search" aria-hidden="true"></i>
                  <input type="text" class="form-control" name="query" value="{{ isset($_GET['query']) ? $_GET['query'] : '' }}" placeholder="Buscar Clínica">
                </div>
              </form>
            </div>
          </div>
              ...
              <table id="registros" class="table table-striped" data-toggle="table" data-sort-name="id" data-sort-order="asc" data-mobile-responsive="true">
                <thead>
                  <tr>
                    ...
                    <th data-field="name" data-sortable="true">Clínica</th>
                    <th data-field="tel" data-sortable="false">Telefone</th>
                    <th data-field="lucro" data-sortable="true">Reponsável</th>
                  ...
                  @foreach($registros as $registro)
                    <tr id="registro-{{ $registro->id }}">
                      ...
                      @can('edit_clinica', 'delete_clinica' )
                        <td>
                          @can('edit_clinica')
                            <a style="text-decoration:none" title="Editar {!! $registro->user->name !!}" href="{{ route('clinicas.editar', $registro->id) }}" class="btn btn-success"><i class="icon fa-pencil"></i> Editar</a>
                          @endcan
                          @can('delete_clinica')
      ...
      <div class="modal-dialog modal-center text-center modal-sm">
        <div class="modal-content">
          ...
          <div class="modal-body" style="padding-top:0">
            ...
            <p style="margin-bottom:0">Tem certeza que deseja excluir a clínica <b id="nameData"></b>?</p>
          </div>
    ...
    @can('add_clinica')
      <div class="site-action" data-plugin="actionBtn">
        ...
        <a href="{{ route('clinicas.adicionar') }}" class="btn-raised btn btn-success btn-floating">
