...
<head>
  ...
  <link rel="stylesheet" href="{{ URL::asset('assets/examples/css/pages/errors.css') }}">
...
<body class="animsition page-error page-error-404 layout-full">
  <div class="page vertical-align text-xs-center" data-animsition-in="fade-in" data-animsition-out="fade-out">
    <div class="page-content vertical-align-middle">
      ...
      <p class="error-advise">Sentimos muito, mas esta página não se encontra em nosso banco de dados.</p>
      <a class="btn btn-primary btn-round" href="{{ route('dashboard') }}">IR PARA A HOME</a>
    </div>
  </div>
