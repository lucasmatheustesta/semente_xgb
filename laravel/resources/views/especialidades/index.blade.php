  ...
  <body class="animsition app-clinicas app-contacts page-aside-left" style="opacity:0">
    ...
    <div class="page bg-white" style="max-width: 100%; margin-top:0;margin-bottom:0">
      ...
      <div class="page-main">
        ...
        <div style="overflow: hidden;" class="page-header">
          <h1 style="float: left" class="page-title">Especialidades</h1>

          <div class="pull-sm-right">
              <form action="{{ route('especialidades') }}" name="search" id="busca">
                <div class="input-search input-search-dark">
                  <i class="input-search-icon md-search" aria-hidden="true"></i>
                  <input type="text" class="form-control" name="query" value="{{ isset($_GET['query']) ? $_GET['query'] : '' }}" placeholder="Buscar Especialidade">
                </div>
              </form>
            </div>
        </div>
              ...
              <table id="registros" class="table table-striped" data-toggle="table" data-sort-name="id" data-sort-order="asc" data-mobile-responsive="true">
                <thead>
                  <tr>
                    ...
                    @can('edit_especialidade', 'delete_especialidade' )
                ...
                <tbody>
                  @foreach($registros as $registro)
                    <tr id="registro-{{ $registro->id }}">
                      ...
                      @can('edit_especialidade', 'delete_especialidade' )
                        <td>
                          @can('edit_especialidade')
                            <a style="text-decoration:none" title="Editar {!! $registro->nome !!}" href="{{ route('especialidades.editar', $registro->id) }}" class="btn btn-success"><i class="icon fa fa-pencil"></i> Editar</a>
                          @endcan
                          @can('delete_especialidade')
      ...
      <div class="modal-dialog modal-center text-center modal-sm">
        <div class="modal-content">
          ...
          <div class="modal-body" style="padding-top:0">
            ...
            <p style="margin-bottom:0">Tem certeza que deseja excluir a Especialidade <b id="nameData"></b>?</p>
          </div>
    ...
    @can('add_regional')
      <div class="site-action" data-plugin="actionBtn">
        ...
        <a href="{{ route('especialidades.adicionar') }}" class="btn-raised btn btn-success btn-floating">
  ...
  <script type="text/javascript">
    jQuery(document).ready(function ($) {
      ...
      function deleteData (id) {
        $.ajax({
          dataType: 'json',
          url: '{{ URL::asset("especialidades/deletar") }}/'+id,
          type: 'GET',
