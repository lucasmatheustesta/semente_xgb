...
<head>
  ...
  <title>Consultor | Maximiza Odonto</title>
      ...
      <div class="panel">
        <div class="panel-body container-fluid">
          <div class="example-wrap">
            <form name="adicionarConsultor" autocomplete="off" enctype="multipart/form-data" action="{{ route('admin.consultores.salvar') }}" method="post">
              
              @include('admin.consultores._form')

              {{ csrf_field() }}

              <div class="form-group form-material text-center">
                <a style="margin-right:20px;" title="Cancelar" href="{{ route('admin.consultores') }}" class="btn btn-default btn-inline btn-lg"><i class="fa fa-ban" aria-hidden="true"></i> Cancelar</a>
