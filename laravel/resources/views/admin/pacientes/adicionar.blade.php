...
<head>
  ...
  <title>Paciente | Maximiza Odonto</title>
  ...
  <div class="page">
    ...
    <div class="page-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">
          <a href="{{ route('admin.pacientes') }}">Pacientes</a>
        </li>
      ...
      <div class="panel">
        <div class="panel-body container-fluid">
          <div class="example-wrap">
            <form name="adicionarConsultor" autocomplete="off" enctype="multipart/form-data" action="{{ route('admin.pacientes.salvar') }}" method="post">
              ...
              <div class="form-group form-material text-center">
                <a style="margin-right:20px;" title="Cancelar" href="{{ route('admin.pacientes') }}" class="btn btn-default btn-inline btn-lg"><i class="fa fa-ban" aria-hidden="true"></i> Cancelar</a>
