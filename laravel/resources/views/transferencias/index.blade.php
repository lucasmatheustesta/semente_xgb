    ...
    <div class="page bg-white" style="max-width: 100%; margin-top:0;margin-bottom:0">
      ...
      <div class="page-main">
        ...
        <div style="overflow: hidden;" class="page-header">
          <h1 style="float: left" class="page-title">Transferências</h1>

          <div class="pull-sm-right">
              <form action="{{ route('faturas') }}" name="search" id="busca">
                <div class="input-search input-search-dark">
                  <i class="input-search-icon md-search" aria-hidden="true"></i>
                  <input type="text" class="form-control" name="query" value="{{ isset($_GET['query']) ? $_GET['query'] : '' }}" placeholder="Buscar Transferência">
                </div>
              </form>
            </div>
        </div>
