@extends('layout.page')
@section('title', 'Locais de Trabalho')
  ...
  <body class="animsition app-clinicas app-contacts page-aside-left" style="opacity:0">
    ...
    <div class="page bg-white" style="max-width: 100%; margin-top:0;margin-bottom:0">
      ...
      <div class="page-main">
        ...
        <div class="page-header">
          <h1 class="page-title">Locais de Trabalho</h1>
        </div>
        <!-- Contacts Content -->
        <div id="contactsContent" class="page-content page-content-table">
          ...
          <div class="page-content-actions">
            <div class="pull-sm-right">
              <form action="{{ route('locaistrabalho') }}" name="search" id="busca">
                <div class="input-search input-search-dark">
                  <i class="input-search-icon md-search" aria-hidden="true"></i>
                  <input type="text" class="form-control" name="query" value="{{ isset($_GET['query']) ? $_GET['query'] : '' }}" placeholder="Buscar Local de Trabalho">
                </div>
              </form>
            </div>
          </div>
              ...
              <table id="registros" class="table table-striped" data-toggle="table" data-sort-name="id" data-sort-order="asc" data-mobile-responsive="true">
                <thead>
                  <tr>
                    ...
                    <th data-field="nome" data-sortable="false">Nome</th>
                    @can('edit_localtrabalho', 'delete_localtrabalho' )
                ...
                <tbody>
                  @foreach($registros as $registro)
                    <tr id="registro-{{ $registro->id }}">
                      ...
                      @can('edit_localtrabalho', 'delete_localtrabalho' )
                        <td>
                          @can('edit_localtrabalho')
                            <a style="text-decoration:none" title="Editar {!! $registro->nome !!}" href="{{ route('locaistrabalho.editar', $registro->id) }}" class="btn btn-success"><i class="icon fa fa-pencil"></i> Editar</a>
                          @endcan
                          @can('delete_localtrabalho')
      ...
      <div class="modal-dialog modal-center text-center modal-sm">
        <div class="modal-content">
          ...
          <div class="modal-body" style="padding-top:0">
            ...
            <p style="margin-bottom:0">Tem certeza que deseja excluir o Local de Trabalho <b id="nameData"></b>?</p>
          </div>
    ...
    @can('add_localtrabalho')
      <div class="site-action" data-plugin="actionBtn">
        ...
        <a href="{{ route('locaistrabalho.adicionar') }}" class="btn-raised btn btn-success btn-floating">
  ...
  <script type="text/javascript">
    jQuery(document).ready(function ($) {
      ...
      function deleteData (id) {
        $.ajax({
          dataType: 'json',
          url: '{{ URL::asset("locais-trabalho/deletar") }}/'+id,
          type: 'GET',
          success: function (json) {
            if (json.success) {
              ...
              $('#deleteData').modal('hide');
              toastr.warning('Ops, houve um erro ao excluir o Local de Trabalho.');
            }
          },
          error: function () {
            $('#deleteData').modal('hide');
