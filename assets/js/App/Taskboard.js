  ...
  var BadgeList = function () {
    ...
    babelHelpers.createClass(BadgeList, [{
      ...
      value: function render() {
        ...
        var duedateData = _duedateData$subtasks.duedateData;
        var subtasksData = _duedateData$subtasks.subtasksData;
        var attachmentsData = _duedateData$subtasks.attachmentsData;
        var commentsData = _duedateData$subtasks.commentsData;
